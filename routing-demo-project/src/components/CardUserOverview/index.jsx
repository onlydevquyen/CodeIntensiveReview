...
const CardUserOverview = () => {
    return (
        <div className=" pt-12">
            <div className="max-w-sm mx-auto bg-white rounded-lg overflow-hidden">
                <div className="border-b px-4 pb-6">
                    <div className="text-center my-4">
                        <Image className='rounded-full' width={150} height={150} src={girlImage} />
                        <div className="py-2">
                            <h3 className="font-bold text-2xl text-gray-800 dark:text-white mb-1">MindX Technology School</h3>
